...
$sql = "SELECT * FROM ngo_signup WHERE ngo_email ='".$ngoemail."'";
...
if($num> 0){
    ...
    while($row = mysqli_fetch_assoc($result)){
       ...
       ?>
            ...
            <p><strong>Name: </strong><?php echo $row['ngo_name'];?></p>
            <p><strong>Mobile No.: </strong><?php echo $row['ngo_mob'];?></p>
            <p><strong>Email: </strong><?php echo $row['ngo_email'];?></p>
            <p><strong>Address: </strong><?php echo $row['ngo_add'];?></p>
            <p><strong>Pincode: </strong><?php echo $row['ngo_pin'];?></p>
...
?>
    ...
    <div class="main-content">
      ...
      <div class="dashboard-page">
        ...
        <div class="res-table">
          <p id="heading-top">Total Restuarant</p>
          <div class="table-res">
            <table>
...
if(isset($_REQUEST['passupdate'])){
  ...
  if($Pass == "" || $cPass == ""){
   ...
   $sql = "UPDATE ngo_signup SET ngo_pass = '$Pass' WHERE ngo_email = '$ngoemail'";
...
?>
  ...
  <button type="submit" class="btn btn-primary mt-3 mb-3" style=" background-color: #2196F3;
  border: none;
  color: white;
  padding: 10px 10px;
  text-align: center;
...
if(($info == "") || ($name == "") || ($email == "") || ($mobile == "") || ($msg == "") || ($date == "")){
  ...
  $sql = "INSERT INTO ngo_message (ngo_info, ngo_name, ngo_email, ngo_mobile, ngo_msg, ngo_date)VALUES('$info', '$name', '$email', '$mobile', '$msg', '$date')";
...
?>
 ...
 <form action="" method="POST">
  ...
  <div class="form-group col-md-6">
    <label for="inputEmail" class="mb-2">Email</label><br>
...
?>
    ...
    <footer class="main-footer">
      ...
      <strong class="no-print">Developed and Maintained by <a href="google.com">Abdul Raza</a>.</strong>
    </footer>
    <!-- FOOTER END -->
  </section>
  <!-- SECTION END -->
