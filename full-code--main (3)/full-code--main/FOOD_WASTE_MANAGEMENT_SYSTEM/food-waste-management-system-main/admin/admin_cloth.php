            ...
            <div class="overview">
                ...
                <div class="boxes">
                    ...
                    <div class="box box2">
                        ...
                        <?php
                           $query="SELECT count(*) as count FROM  user_feedback_cloth";
                           $result=mysqli_query($connection, $query);
                           $row=mysqli_fetch_assoc($result);
                         echo "<span class=\"number\">".$row['count']."</span>";
                        ?>
...
$sql = "SELECT * FROM cloth_donations WHERE assigned_to IS NULL ";
...
if (isset($_POST['cloth']) && isset($_POST['delivery_person_id'])) {

    
    $order_id = $_POST['order_id'];
    $delivery_person_id = $_POST['delivery_person_id'];
    $sql = "SELECT * FROM cloth_donations WHERE Cid = $order_id AND assigned_to IS NOT NULL";
    $result = mysqli_query($connection, $sql);
    ...
    $sql = "UPDATE cloth_donations SET assigned_to = $delivery_person_id WHERE Cid = $order_id";
            ...
            <td data-label="Action" style="margin:auto">
                <?php if ($row['assigned_to'] == null) { ?>
                    <form method="post" action=" ">
                        ...
                        <button type="submit" name="cloth">Get cloth</button>
                    </form>
...
<!-- 
       ...
       <tbody>
        ...
        $query="select * from cloth_donations where address='Amravati' ";
        $result=mysqli_query($connection, $query);
        if($result==true){
            while($row=mysqli_fetch_assoc($result)){
