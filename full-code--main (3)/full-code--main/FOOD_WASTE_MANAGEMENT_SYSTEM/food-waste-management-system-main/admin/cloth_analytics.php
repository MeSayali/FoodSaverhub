...
<body>
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="cloth_adminprofile.php">
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>cloth Donate</p> -->
            <p  class ="logo" >cloth <b style="color: #06C167; ">Donate</b></p>
             <p class="user"></p>
            ...
            <div class="overview">
                ...
                <div class="boxes">
                    ...
                    <div class="box box3">
                        ...
                        <?php
                           $query="SELECT count(*) as count FROM cloth_donations";
                           $result=mysqli_query($connection, $query);
                           $row=mysqli_fetch_assoc($result);
                         echo "<span class=\"number\">".$row['count']."</span>";
                        ?>
...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM cloth_donations where address=\"rajkamal\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $rajkamal=$ro3['count'];
            $q4="SELECT count(*) as count FROM cloth_donations where address=\"panchawati\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $panchwati=$ro4['count'];
            $q5="SELECT count(*) as count FROM cloth_donations where address=\"irvin_square\"";
            $res5=mysqli_query($connection, $q5);
            $ro5=mysqli_fetch_assoc($res5);
            $irvin_square=$ro5['count'];
            

    ?>
var xValues = ["Male","Female"];
var xplace=["rajkamal","panchwati","irvin_square"];
var yplace=[<?php echo json_encode($rajkamal,JSON_HEX_TAG);?>,<?php echo json_encode($irvin_square,JSON_HEX_TAG);?>,<?php echo json_encode($panchwati,JSON_HEX_TAG);?>];
