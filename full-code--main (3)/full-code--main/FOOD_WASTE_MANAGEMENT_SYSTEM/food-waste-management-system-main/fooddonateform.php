...
<body style="    background-color: green;">
    ...
    <form action="" method="post">
       ...
       <div class="input">
        ...
        <div class="input">
        <label for="quantity">Quantity:(number of person)</label>
...
<select id="district" name="district" style="padding:10px;">
  <option value="amravati">Amravati</option>
        ...
        <select id="address" name="address" style="padding:10px;">
        <option value="panchwati">panchwati</option>
        <option value="gadge_nagar">gadge-nagar</option>
        <option value="irvin-square">irvin-square</option>
        <option value="rajkamal">rajkamal</option>
        <option value="vilas-nagar">vilas-nagar</option>
        </select> 
