...
<body>
    ...
    .uil {
     ...
     <style>
        body {
            background-image: url('img/login.jpg'); /* Replace 'img/login.jpg' with the URL of your background image */
    ...
    <div class="container">
        <div class="regform">
            ...
            <form action=" " method="post">
                ...
                <p class="logo" style="">Food <b>Donate</b></p>
