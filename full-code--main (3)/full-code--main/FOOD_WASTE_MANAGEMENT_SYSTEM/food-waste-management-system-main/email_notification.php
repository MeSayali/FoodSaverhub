...
$to_email = "jaysingpuresakshi@gmail.com";
$predefined_message = "user send donation request to your application ...";
$subject = "Check your admin dashboard"; // You can set your subject here
...
try {
    //Server settings
    $mail->SMTPDebug = 0; // Enable verbose debug output (change to 0 in production)
    $mail->isSMTP(); // Send using SMTP
    $mail->Host = 'smtp.gmail.com'; // Set the SMTP server to send through
    $mail->SMTPAuth = true; // Enable SMTP authentication
    $mail->Username = 'sakshijaysingpure5@gmail.com'; // SMTP username
    $mail->Password = 'vtnuneastrmemiej'; // SMTP password
